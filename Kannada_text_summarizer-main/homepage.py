...
def Summarize():
    ...
    file_path = path.relpath("C:\Kannada_text_summarizer-main\DataSet1\kannada_stopwords.txt")
    ...
    file_path2 = path.relpath("C:\Kannada_text_summarizer-main\summ\wiki.kn - Copy.txt")
                              #C:/Users/RAVIKUMAR/Desktop/SEM 8/Porject/wiki.kn - Copy.txt")
    word_embeddings = {}
