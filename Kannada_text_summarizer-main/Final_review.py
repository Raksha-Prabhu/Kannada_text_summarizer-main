...
def Summarize():
    sentences = []
    print("\t\t\t************* PLEASE WAIT **************\n")
    with open("Kannada_dataset.txt","r", encoding="utf8") as file:
        read=file.readlines()
    for s in read:
    ...
    file_path = path.relpath("C:\Kannada_text_summarizer-main\s\kannada_stopwords.txt")
    ...
    file_path2 = path.relpath("C:\Kannada_text_summarizer-main\s\wiki.kn - Copy.txt")
    word_embeddings = {}
